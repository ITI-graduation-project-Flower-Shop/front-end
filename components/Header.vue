...
<template>
  <header class="absolute w-full bg-transparent text-white px-5 lg:px-10  z-50">
    <div class="container mx-auto flex justify-between items-center text-indigo-950"
      ...
      <!-- Moblie View -->
      <div v-if="showMenu" class="absolute top-16 left-0 w-full bg-white text-indigo-950 p-5 flex flex-col items-center gap-4 md:hidden z-90">
      ...
      <template v-else>
          <div class="w-40 inline-flex justify-between items-end">
                  ...
                  <nuxt-link to="/" class=" "
                   ...
                   >
                      <svg 
                          ...
                          width="26" height="26" viewBox="0 0 31 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <nuxt-link to="/ShoppingCart" class=" "
                   :exact-active-class="'aactive-icon'"
                   exact
                  >
                      <svg 
                          class="text-indigo-950" 
                  ...
                  <nuxt-link to="/profile"
                   ...
                   >
                      <svg 
                          class="text-indigo-950" 
                          width="28" height="26" viewBox="0 0 31 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
